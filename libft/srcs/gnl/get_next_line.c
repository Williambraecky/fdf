...
/*   Updated: 2018/07/31 12:59:07 by wbraeckm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_line	*ft_new_line(const int fd, char *buffer, size_t len)
{
	t_line	*line;
...
int		ft_clean(void *content, void *data_ref)
{
	t_line	*line;
	int		*fd;
...
char	*ft_join_lines(t_list *list, const int fd, size_t count)
{
	t_line	*line;
	char	*str;
	size_t	nl_index;
...
int		ft_read_next_line(t_list **list, const int fd, int *count, char *buffer)
{
	t_list	*current;
	t_line	*l;
	int		j;
